# languages.py - Configuration des langues pour l'interface
...
LANGUAGES = {
    "English": {
        ...
        "exit": "Exit",
        "deck_filename": "📂 CSV deck file name",
        ...
        "generate_deck": "Generate deck (mp3 + csv)",
        "temp_cards": "📄 Temporary cards (double-click to edit, DEL to remove)",
        "error": "Error",
        "success": "Success",
        "done": "Done",
        "loading": "🔄 Loading...",
    ...
    "Français": {
        ...
        "exit": "Quitter",
        "deck_filename": "📂 Nom du fichier CSV",
        ...
        "generate_deck": "Générer le deck (mp3 + csv)",
        "temp_cards": "📄 Cartes temporaires (double-clic pour éditer, SUPPR pour supprimer)",
        "error": "Erreur",
        "success": "Succès",
        "done": "Terminé",
        "loading": "🔄 Chargement...",
